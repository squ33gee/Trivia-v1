namespace Trivia
{
    partial class Question4
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "На каком уровне располагается протокол DNS?";
