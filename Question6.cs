...
namespace Trivia
{
    public partial class Question6 : Form
    {
        public Question6()
        {
            ...
            {
                label3.Text = "Score:";
                label1.Text = "Question №6";
                label2.Text = "What is the speed in category twisted pair cable CAT4?";

                button1.Text = "16 Mbit/sec";
                button2.Text = "100 Mbit/sec";
                button3.Text = "4 Mbit/sec";
                button4.Text = "16 MB/sec";
