...
namespace Trivia
{
    public partial class Question8 : Form
    {
        public Question8()
        {
            ...
            {
                label3.Text = "Score:";
                label1.Text = "Question №8";
                label2.Text = "Visible light - wavelengths within...";

                button1.Text = "above 700 nm";
                button2.Text = "from 700 to 400 nm";
                button3.Text = "less than 700 nm";
                button4.Text = "700 nm and above";
